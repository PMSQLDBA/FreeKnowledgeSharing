...
Backup new certificate
Re-protect DEK with new certificate
Validate thumbprint match
Test restore (optional)
Keep old certificate (recommended period)
...
Getting Help
Review logs in application output panes
Check "Scripts" tab for solutions
